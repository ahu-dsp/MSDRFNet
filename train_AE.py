...
def train(i, original_imgs_path):
    ...
    Is_testing = 0
    UNF_model = FusionModule(Is_testing,deepsupervision=True)
    ...
    # loss_filename_path = 'models/loss/function/AE/pixel_0.83_smooth1.mat'
    ...
    # loss_filename_path = "models/loss/function/AE/ssim_0.83_sm1.mat"
    ...
    # loss_filename_path = "models/loss/function/AE/all_0.83_smooth1.mat"
    ...
    # save_model_filename = "model/function/AE/0.83_smooth1.model"
